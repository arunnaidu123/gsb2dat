...
CFLAGS=-I/usr/local/cuda-8.0/include/ -I/usr/local/cuda-8.0/samples/common/inc/ -L/usr/local/cuda-8.0/lib64 -L/usr/local/pgplot/ -lcufft
...
CPP = g++ -g -Wall
ALL_CFLAGS = -ccbin g++ -I/usr/local/cuda-8.0/include/ -I/usr/local/cuda-8.0/samples/common/inc/  -m64 \
